...
class LoadBalancersModel {
  ...
  LoadBalancersModel.fromJson(Map<String, dynamic> json)
      : loadBalancers = (json['load_balancers'] as List)
            .map((e) => LoadBalancerModel.fromJson(e)),
        meta = MetaModel.fromJson(json['load_balancers']);

  Map<String, dynamic> toJson() =>
      {"load_balancers": loadBalancers, "meta": meta};
}
...
class LoadBalancerModel {
  ...
  LoadBalancerModel.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        hasSsl = json['has_ssl'],
        forwardingRules = (json['forwarding_rules'] as List)
            .map((e) => LoadBalancerForwardingRuleModel.fromJson(e)),
...
class SSLLoadBalancerModel {
  ...
  Map<String, dynamic> toJson() =>
      {"priate_key": priateKey, "certificate": certificate, "chain": chain};
}
...
class LoadBalancerForwardingRulesModel {
  ...
  Map<String, dynamic> toJson() =>
      {"forwarding_rules": forwardingRules, "meta": meta};
}
