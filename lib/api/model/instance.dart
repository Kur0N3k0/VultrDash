...
class InstancesModel {
  ...
  InstancesModel.fromJson(Map<String, dynamic> json)
      : instances =
            (json['instances'] as List).map((e) => InstanceModel.fromJson(e)),
        meta = MetaModel.fromJson(json['instances']);

  Map<String, dynamic> toJson() => {"instances": instances, "meta": meta};
}
...
class PrivateNetworksInstanceModel {
  ...
  PrivateNetworksInstanceModel.fromJson(Map<String, dynamic> json)
      : privateNetworks = (json['private_networks'] as List)
            .map((e) => PrivateNetworkInstanceModel.fromJson(e)),
        meta = MetaModel.fromJson(json['private_networks']);

  Map<String, dynamic> toJson() =>
      {"private_networks": privateNetworks, "meta": meta};
}
...
class ISOStatusInstanceModel {
  ...
  Map<String, dynamic> toJson() => {"status": status, "iso_id": isoId};
}
...
class BackupScheduleInstanceModel {
  ...
  Map<String, dynamic> toJson() =>
      {"type": type, "hour": hour, "dow": dow, "dom": dom};
}
...
class IPv4sInstanceModel {
  ...
  IPv4sInstanceModel.fromJson(Map<String, dynamic> json)
      : ipv4s =
            (json['ipv4s'] as List).map((e) => IPv4InstanceModel.fromJson(e)),
        meta = MetaModel.fromJson(json['ipv4s']);

  Map<String, dynamic> toJson() => {"ipv4s": ipv4s, "meta": meta};
}
...
class IPv6sInstanceModel {
  ...
  IPv6sInstanceModel.fromJson(Map<String, dynamic> json)
      : ipv46 =
            (json['ipv46'] as List).map((e) => IPv6InstanceModel.fromJson(e)),
        meta = MetaModel.fromJson(json['ipv46']);

  Map<String, dynamic> toJson() => {"ipv46": ipv46, "meta": meta};
}
...
class ReverseIPModel {
  ...
  Map<String, dynamic> toJson() => {"ip": ip, "reverse": reverse};
}
