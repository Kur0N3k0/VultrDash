...
class ISOsModel {
  ...
  Map<String, dynamic> toJson() => {"isos": isos, "meta": meta};
}
...
class PublicISOsModel {
  ...
  PublicISOsModel.fromJson(Map<String, dynamic> json)
      : publicIsos =
            (json['public_isos'] as List).map((e) => ISOModel.fromJson(e)),
        meta = MetaModel.fromJson(json['public_isos']);

  Map<String, dynamic> toJson() => {"public_isos": publicIsos, "meta": meta};
}
